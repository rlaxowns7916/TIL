...
| 2026-02-09 | Transactional Outbox + CDC(Debezium) | [NEW] | [PR 예정] | - | (this PR) | DB-메시징 원자성 문제를 Outbox+CDC로 해결하는 패턴 정리 |
| 2026-02-09 | Kafka Exactly-Once Semantics(EOS) | [FIX] | [PR 예정] | - | (this PR) | 용어/흐름/운영 관점 중심으로 문서 리라이트(ASCII 다이어그램 포함) |
